                        ...
                        <div class="row">
                            <div class="span12">
                                ...
                                <div id="check-accordion">
                                    ...
                                    -->
                                    <h5><small> Just Do it</small><a href="#"> Редактирование данных</a></h5>
                                    ...
                                    <div class=" clearfix">
                                        ...
                                        <?php if (isset($errors) && $error==true)
                                                    {
                                                        foreach ($errors as $er) {
                                                            echo "<label id='special' style='margin-left=40px'>$er</label><br/><br/>";
                                        ...
                                        <form action="#" method="post" class="billing-form clearfix">
                                            <fieldset>
                                             <label>Введите Логин</label>
                                                <input name="login" type="login" value="<?php echo $UsersData->login;?>" placeholder="Логин"><br/>
                                                <label>Введите e-mail адрес</label>
                                                <input name="email" type="text" value="<?php  echo $UsersData->email;?>" placeholder="e-mail"><br/>
                                                <label> Ваш пароль</label>
                                                <input name="password" type="password" value="<?php ?>" placeholder="Пароль"><br/>
                                                <label>  Повторите пароль</label>
                                                <input name="password2" type="password" value="<?php ?>"  placeholder="Пароль"><br/>
                                                <!-- <a href="#" >Forgot your password ?</a> -->
                                            </fieldset>
                                            <fieldset>
                                                <label>Фамилия</label>
                                                <input name="second_name" type="text" value="<?php echo $UsersData->second_name;?>"/>
                                                <label>Отчество</label>
                                                <input name="third_name" type="text" value="<?php echo $UsersData->third_name;?>"/>
                                            </fieldset>

                                            <fieldset class="last">
                                                <label> Имя</label>
                                                <input name="name" type="text" value="<?php  echo $UsersData->name;?>"/>
                                                    <label> Телефон</label>
                                                <input name="phone" type="text" value="<?php  echo $UsersData->phone;?>"/>
                                             
                                            </fieldset>

                                            <label> Адрес </label>
                                            <input name="address" type="text" value="<?php  echo $UsersData->address;?>"/>  
                                            <label> Почтовый индекс </label>
                                            <input name="index" type="text" value="<?php  echo $UsersData->index;?>"/>  

                                         

                                            <input name="submit" type="submit" value="Сохранить" class="red-button">
